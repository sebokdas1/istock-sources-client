...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li className='lg:text-white'><Link to="/my-portfolio">My Portfolio</Link></li>
        {
            user && <li className='lg:text-white'><Link to="/dashboard">Dashboard</Link></li>
        }
    ...
    return (
        <div className="navbar bg-cyan-600 shadow lg:w-full">
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost normal-case text-white text-xl">Istock Sources</Link>
            </div>
